...
export function fetchDestination(radius, kinds) {
    ...
    // xios.get('https://api.opentripmap.com/0.1/en/places/radius?radius=10000&lon=-78.9032316&lat=35.9962091&kinds=museums&format=json&limit=5&apikey=5ae2e3f221c38a28845f05b6f59339d379a141fda53f5bd095ddcbb9')
        // console.log(request)
